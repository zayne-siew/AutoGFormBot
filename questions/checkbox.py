...
import logging
from questions.base import BaseOptionQuestion, BaseOptionGridQuestion
...
class CheckboxQuestion(BaseOptionQuestion):
    ...
    def get_info(self) -> Optional[bool]:
        ...
        elements = self._QUESTION_ELEMENT.find_elements_by_class_name(self._CHECKBOX_CLASS_NAME)
